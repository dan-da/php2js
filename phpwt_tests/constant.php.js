...
___echo("Test define works correctly with a string<br>\n");
___echo("result: "+(APPLE_COLOR==="red"?"pass":"fail")+"<br><br>\n\n");

}

test2 = function() {
define("APPLE_COUNT",3);
___echo("Test define works correctly with an integer<br>\n");
___echo("result: "+(APPLE_COUNT===3?"pass":"fail")+"<br><br>\n\n");

}

test3 = function() {
___echo("Test global define works correctly<br>\n");
___echo("result: "+(GLOBAL_CONST==="globals_r_bad"?"pass":"fail")+"<br><br>\n\n");
