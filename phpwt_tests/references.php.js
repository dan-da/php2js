...
test1 = function() {
test1_internal = function(foo) {
foo.o = 6;
}

var bar;
bar = 3;
test1_internal((___bar_={o:bar}));bar=___bar_.o;
...
test2 = function() {
{ /* begin class goo */
function goo() {}} /* end class goo */
test2_internal = function(foo) {
foo.o+=3;
}
...
bar = new goo;
bar.total = 3;
test2_internal((___total_={o:bar.total}));bar.total=___total_.o;
___echo("Test passing object attributes by reference.<br>\n");
___echo("result: "+(bar.total===6?"pass":"fail")+"<br><br>\n\n");
}

test3 = function() {
test3_internal = function(foo) {
foo.o+=1;
}

var baz;
baz = ___array(5);
test3_internal((___baz_={o:baz[0]}));baz[0]=___baz_.o;
___echo("Test passing array elements by reference.<br>\n");
___echo("result: "+(baz[0]==6?"pass":"fail")+"<br><br>\n\n");
}
