...
test1 = function() {
var data = parseInt("2");
___echo("Test casting numeric string to an int<br>\n");
___echo("result: "+(data===2?"pass":"fail")+"<br><br>\n\n");
}

test2 = function() {
var data = String(2);
___echo("Test casting integer to a string<br>\n");
___echo("result: "+(data==="2"?"pass":"fail")+"<br><br>\n\n");
}

test3 = function() {
var data = parseInt(2.345);
___echo("Test casting float to an integer<br>\n");
___echo("result: "+(data===2?"pass":"fail")+"<br><br>\n\n");
}
