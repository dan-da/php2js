...
test1 = function() {
var foo;
foo = ___array(5,6,7,8);
var a;
var b;
var c;
var ____i = 0;____tmp = foo;a = ____tmp[____i++];b = ____tmp[____i++];c = ____tmp[____i++];;
___echo("Test that list(\$a, \$b, \$c) work correctly<br>\n");
___echo("result: "+(a===5&&b==6&&c==7?"pass":"fail")+"<br><br>\n\n");
