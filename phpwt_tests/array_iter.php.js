...
test1 = function() {
var arr = ___array("val1",[ "__kv", "key","val2"],"val3","val4",[ "__kv", "key2","val5"]);
var buf = "";
for(var key in arr) {
var value=arr[key];
buf+=value+" ";
}
___echo("Test that mixed assoc and indexed values maintain original order<br>\n");
___echo("Result: "+((buf==="val1 val2 val3 val4 val5 ")?"pass":"fail")+"<br><br>\n\n");

}

test2 = function() {
var arr = ___array([ "__kv", "key1","val1"],[ "__kv", "key2","val2"],"val3","val4",[ "__kv", "key5","val5"],"val6","val7","val8",[ "__kv", "key9","val9"]);
var buf = "";
for(var key in arr) {
var value=arr[key];
buf+=""+key+":"+value+" ";
}
___echo("Test (again) that mixed assoc and indexed values maintain original order<br>\n");
___echo("Result: "+((buf==="key1:val1 key2:val2 0:val3 1:val4 key5:val5 2:val6 3:val7 4:val8 key9:val9 ")?"pass":"fail")+"<br><br>\n\n");
