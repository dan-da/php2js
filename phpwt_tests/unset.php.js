...
var foo = "hello";
foo = undefined;
___echo("Test unset( \$var )   (scalar variable)<br>\n");
...
delete arr[1];
___echo("Test unset() of a numeric array index<br>\n");
___echo("Result: "+((count(arr)===5&&arr[1]==null)?"pass":"fail")+"<br><br>\n\n");

}

test3 = function() {
var arr = ___array([ "__kv", "red","Red"],[ "__kv", "green","Green"]);
delete arr["red"];
___echo("Test unset() of a string array index<br>\n");
___echo("Result: "+((count(arr)==1&&!arr["red"])?"pass":"fail")+"<br><br>\n\n");
}

test4 = function() {
function _foo() {this.name="bar";} {} /* end class _foo */
var f = new _foo;
delete f.name;
___echo("Test unset() of an object property<br>\n");
___echo("Result: "+((f.name==null)?"pass":"fail")+"<br><br>\n\n");
}

test5 = function() {
var arr = ___array([ "__kv", "colors",___array("red","green","blue")],1,2,3);
delete arr["colors"][1];
___echo("Test unset() of a nested array index<br>\n");
___echo("Result: "+((count(arr["colors"])===2&&arr["colors"][1]==null)?"pass":"fail")+"<br><br>\n\n");
